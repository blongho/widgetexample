...
class MessageWidget {
    ...
    position = "";        // position of widget in the DOM
    open = false;       // toggle the state of the widget (open/closed)
    widgetContent = null;   // html element(s) of the widget

    async initialize() { // display and create the widget
        /**
    ...
    injectStyles() { // adds styling to the widget
